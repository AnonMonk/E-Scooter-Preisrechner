...
void drawTextField(float x, float y, float w, float h, const string& text, bool active, bool isPassword, bool showCursor) {
    // Hintergrund - hellerer Grauton f�r bessere Lesbarkeit
    if (active) {
    ...
    // Text anzeigen - helles Wei�, vertikal zentriert
...
void drawLoginDialog() {
    ...
    // Dialog-Hintergrund - dunkler f�r besseren Kontrast
    ...
    // Label: Benutzername - helleres Wei�
    glColor3f(1.0f, 1.0f, 1.0f);
    void* font = GLUT_BITMAP_HELVETICA_18;
